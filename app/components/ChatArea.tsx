...
export default function ChatArea() {
  ...
  return (
    <div className="chat-area flex flex-col h-full bg-[#110c1a]">
      {/* Chat messages area */}
      <div className="messages-container flex-grow p-4 overflow-y-auto">
        ...
        <div className="flex flex-col space-y-4">
          ...
          <div className="bg-[#281e3c] rounded-lg p-4 max-w-[80%] self-start">
            <p className="text-white">This is where chat messages would appear.</p>
          </div>
          
          <div className="bg-[#281e3c] rounded-lg p-4 max-w-[80%] self-end">
      ...
      <div className="input-container p-4 border-t border-gray-700">
        <div className="bg-[#281e3c] rounded-lg p-2 flex items-end">
          {/* Upload image button */}
          <div className="upload-section flex items-center p-2 rounded-lg bg-[#ffddd0] text-black mr-2">
            <div className="mr-2">
