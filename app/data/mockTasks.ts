...
export const taskData: Task[] = [
  {
    ...
    ai_verification_instructions: "Analyze photos for demining evidence",
  ...
  },
  {
    ...
    ai_verification_instructions: "Compare before/after images for repairs",
  ...
  },
  {
    ...
    ai_verification_instructions: "Analyze footage for strike confirmation by: 1) Detecting explosion signature and blast radius, 2) Identifying target equipment before and after strike, 3) Assessing structural damage patterns consistent with successful hit, 4) Verifying timestamp and geolocation metadata. Respond with 'true' if hit confirmed or 'false' if inconclusive/missed.",
    human_verification_instructions: null,
    template: "PHOTO",
    can_open: true,
    participants: 3,
