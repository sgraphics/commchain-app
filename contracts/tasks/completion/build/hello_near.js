...
let TaskStatus = /*#__PURE__*/function (TaskStatus) {
  TaskStatus[TaskStatus["Registered"] = 0] = "Registered";
  TaskStatus[TaskStatus["Verified"] = 1] = "Verified";
  return TaskStatus;
}({});

// Task completion interface
let TaskCompletionContract = (_dec = NearBindgen({}), _dec2 = initialize(), _dec3 = call({}), _dec4 = view(), _dec5 = call({}), _dec6 = view(), _dec7 = call({}), _dec8 = call({}), _dec9 = view(), _dec10 = view(), _dec11 = view(), _dec(_class = (_class2 = class TaskCompletionContract {
  static schema = {
    owner: 'string',
    verifier: 'string?',
    taskCompletions: 'LookupMap<TaskCompletion>',
    taskIds: 'Vector<number>',
    nextId: 'number'
  };
  constructor() {
    this.owner = "";
  ...
  assertVerifier() {
    if (this.verifier) {
      if (predecessorAccountId() !== this.verifier) {
...
}, _applyDecoratedDescriptor(_class2.prototype, "init", [_dec2], Object.getOwnPropertyDescriptor(_class2.prototype, "init"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setOwner", [_dec3], Object.getOwnPropertyDescriptor(_class2.prototype, "setOwner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getOwner", [_dec4], Object.getOwnPropertyDescriptor(_class2.prototype, "getOwner"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "setVerifier", [_dec5], Object.getOwnPropertyDescriptor(_class2.prototype, "setVerifier"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getVerifier", [_dec6], Object.getOwnPropertyDescriptor(_class2.prototype, "getVerifier"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "register", [_dec7], Object.getOwnPropertyDescriptor(_class2.prototype, "register"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "verify", [_dec8], Object.getOwnPropertyDescriptor(_class2.prototype, "verify"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTaskCompletion", [_dec9], Object.getOwnPropertyDescriptor(_class2.prototype, "getTaskCompletion"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getLatestTaskCompletions", [_dec10], Object.getOwnPropertyDescriptor(_class2.prototype, "getLatestTaskCompletions"), _class2.prototype), _applyDecoratedDescriptor(_class2.prototype, "getTaskCompletionsPage", [_dec11], Object.getOwnPropertyDescriptor(_class2.prototype, "getTaskCompletionsPage"), _class2.prototype), _class2)) || _class);
function getTaskCompletionsPage() {
  const _state = TaskCompletionContract._getState();
  if (!_state && TaskCompletionContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  const _contract = TaskCompletionContract._create();
  if (_state) {
    TaskCompletionContract._reconstruct(_contract, _state);
  }
  const _args = TaskCompletionContract._getArgs();
  const _result = _contract.getTaskCompletionsPage(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function getLatestTaskCompletions() {
  const _state = TaskCompletionContract._getState();
  if (!_state && TaskCompletionContract._requireInit()) {
    throw new Error("Contract must be initialized");
  }
  ...
  const _args = TaskCompletionContract._getArgs();
  const _result = _contract.getLatestTaskCompletions(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function getTaskCompletion() {
  ...
  const _args = TaskCompletionContract._getArgs();
  const _result = _contract.getTaskCompletion(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function verify() {
  const _state = TaskCompletionContract._getState();
  ...
  TaskCompletionContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function register() {
  const _state = TaskCompletionContract._getState();
...
function getVerifier() {
  ...
  const _args = TaskCompletionContract._getArgs();
  const _result = _contract.getVerifier(_args);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function setVerifier() {
  ...
  const _args = TaskCompletionContract._getArgs();
  const _result = _contract.setVerifier(_args);
  TaskCompletionContract._saveToStorage(_contract);
  if (_result !== undefined) if (_result && _result.constructor && _result.constructor.name === "NearPromise") _result.onReturn();else env.value_return(TaskCompletionContract._serialize(_result, true));
}
function getOwner() {
...
export { TaskStatus, getLatestTaskCompletions, getOwner, getTaskCompletion, getTaskCompletionsPage, getVerifier, init, register, setOwner, setVerifier, verify };
